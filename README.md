...
<a href="https://github.com/Phantom-19/link/stargazers/"><img title="Étoiles" src="https://img.shields.io/github/stars/Phantom-19/insta_hack??color=red&style=flat-square"></a>
<a href="https://github.com/Phantom-19/link/network/members"><img title="Fourches" src="https://img.shields.io/github/forks/Phantom-19/insta_hack??color=red&style=flat-square"></a>
<a href="https://github.com/Phantom-19/link/watchers"><img title="En train de regarder" src="https://img.shields.io/github/watchers/Phantom-19/insta_hack?label=Watchers&color=blue&style=flat-square"></a>
<p align="right">
<a href="#"><img title="Langage" src="https://forthebadge.com/images/badges/made-with-python.svg"></a>
</p>

## `Installation Insta_hack `:

* `apt update`
* `apt install git python2 python `
* `git clone https://github.com/Phantom-19/insta_hack.git`
* `cd insta_hack`
* `pip2 install tqdm`
* `pip2 install requests`

## ` Execution > ` `python2 instagram`
...
```
apt update ; apt install git curl -y ; git clone https://github.com/Phantom-19/insta_hack.git ; cd insta_hack ; pip2 install mechanize ;   pip2 install requests ; python2 instagram
```
